...
**결과:**
Detergent 용액은 복잡한 system이며 연구하기 어렵다.
...
3. **Lipid molecule 일부 유지**
   - 보통 일부 lipid molecule도 protein에 부착된 채로 남음

위 그림은 mild nonionic detergent로 membrane protein을 가용화하는 과정을 보여준다. Detergent가 [[Lipid bilayer]]를 파괴하고 protein을 protein-lipid-detergent complex로 용액에 가져온다. Membrane의 [[Phospholipid]]도 lipid-detergent micelle로 가용화된다.
...
- [[Membrane protein]]의 SDS polyacrylamide-gel electrophoresis 분석 허용
...
![[Cell Biology/출처/md converted/Chapter 10/_page_22_Figure_1.jpeg]]

위 그림은 mild nonionic detergent를 사용하여 기능적 membrane protein system을 가용화, 정제, 재구성하는 과정을 보여준다:

**예시: Na⁺-K⁺ pump**
1. Detergent로 membrane 가용화
2. Functional Na⁺-K⁺ pump molecule 정제
3. [[Phospholipid]] vesicle에 incorporate
4. 이 pump는 대부분의 동물 세포 plasma membrane에 존재
5. ATP hydrolysis의 energy를 사용하여:
   - Na⁺를 세포 밖으로 pump
   - K⁺를 세포 안으로 pump
...
![[Cell Biology/출처/md converted/Chapter 10/_page_22_Figure_2.jpeg]]
...
**장점:**
1. Native lipid environment에서 membrane protein 연구 가능
2. Bilayer 양쪽에서 실험적으로 접근 가능
3. Ligand-binding experiment에 유용
4. Single-particle electron microscopy로 구조 분석 가능
5. Protein crystallization 필요 없음
