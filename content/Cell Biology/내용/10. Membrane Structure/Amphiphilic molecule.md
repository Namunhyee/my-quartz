...
![[Cell Biology/출처/md converted/Chapter 10/_page_4_Picture_1.jpeg]]
...
**Driving force:**
1. Hydrophobic tail의 물 노출을 최소화
2. Hydrophilic head의 물 노출을 최대화
...
위 그림 (B)는 [[Micelle]]과 [[Lipid bilayer]]의 단면을 보여준다.
...
2. Free edge 생성 → 물에 노출됨
3. 이는 energetically unfavorable
   - Hydrophobic tail이 물과 접촉하게 됨
4. Lipid가 자발적으로 재배열하여 free edge 제거
5. **중요:** Free edge를 피하는 유일한 방법은 자신을 닫는 것
6. 결과: Sealed compartment 형성

**생물학적 의의:**
이 remarkable behavior는 살아있는 세포 창조의 근본이다:
...
**이유:**
1. 모든 또는 거의 모든 atom이 uncharged and nonpolar
2. 물 molecule과 energetically favorable interaction 형성 불가
3. 물 속에 분산되면:
...
**Clustering:**
Entropic free-energy cost는 다음과 같이 최소화된다:
...
**Amphiphilic molecule의 경우:**
이 원리가 [[Phospholipid]]와 같은 amphiphilic molecule을 다음과 같이 pack하도록 유도:
...
많은 [[Membrane protein]]도 amphiphilic 특성을 보인다:
...
- [[Lipid anchor#Fatty Acid Anchor|Lipid-anchored protein]]

## Detergent로서의 Amphiphilic Molecule

[[Detergent]]는 작은 amphiphilic molecule이다:
...
Detergent의 amphiphilic 특성이 [[Membrane protein#Detergent를 통한 가용화|membrane protein 가용화]]에 이용됨
