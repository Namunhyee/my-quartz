...
**Cytochrome c reductase** (Complex III, cytochrome b-c₁ complex)는 ETC의 두 번째 proton pump이다. Ubiquinol(QH₂)로부터 전자를 받아 soluble carrier protein인 **cytochrome c**로 전달하며, **Q cycle** 메커니즘을 통해 proton을 crista space로 방출한다.
