...
**Cytochrome c oxidase** (Complex IV)는 ETC의 마지막 complex로, cytochrome c로부터 전자를 받아 **O₂를 물(H₂O)로 환원**시키는 반응을 촉매한다.[^기출_기말_2022_19][^기출_기말_2023_8][^기출_기말_2023_11][^기출_기말_2023_12] 동시에 세 번째 proton pump로 기능한다.
...
[^기출_기말_2022_19]: [[Cell Biology/기출 DB/기말고사/2022년/final_2022_19번|2022 기말 19번]] — Cyanide의 Complex IV 억제 → ETC 정지 → ATP 합성 불가 → 사망 원리 서술형 문항.
