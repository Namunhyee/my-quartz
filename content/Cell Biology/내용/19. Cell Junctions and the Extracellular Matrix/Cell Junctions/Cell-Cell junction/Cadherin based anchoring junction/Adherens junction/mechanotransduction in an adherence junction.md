...
Adherens junction은 기계적 힘을 감지하고, 이에 반응하여 actin cytoskeleton 연결을 강화하는 **tension sensor**로 작동한다. 이러한 기계적 신호의 생화학 신호로의 변환을 **mechanotransduction**이라 한다.
...
4. 이 변화는 [[Rho family|Rac/Rho 등의 small GTPase에 의한 actin/myosin 행동 조절]]로도 이어질 것으로 추정된다.
