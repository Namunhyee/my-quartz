...
### ==특성; cadherin과 비교==
- caludin과 occludin은 [[Homophilic vs heterophilic binding|homophilic binding]]을 함.
- [[00_Cadherin based adhension_MOC|cadherin]]보다 dynamicity가 낮음.
- 불규칙한 패턴으로 배열됨. 일정한 방향으로 찢어지지 않기 위해서. 이것은 [[structure and function of cadherin|cadherin의 배열]]과는 상반됨.
