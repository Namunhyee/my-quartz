...
**Heterophilic binding**은 서로 다른 종류의 분자 사이의 결합이다. [[Integrins in Cell-to-Cell interaction|Selectin]]이 대표적 예로, 백혈구 표면의 selectin이 내피세포 표면의 [[Oligosaccharides|oligosaccharide]]에 결합한다. 일부 [[integrin_MOC|integrin]]도 다른 세포 표면의 Ig superfamily protein에 결합할 때 heterophilic binding을 이용한다.
