...
**Hemidesmosome**은 상피세포를 [[Basal Lamina_MOC|basal lamina]]에 부착시키는 특수화된 cell-matrix junction이다.
...
Hemidesmosome은 상피를 underlying connective tissue에 단단히 고정시킨다. 예를 들어 피부에서 epidermis를 dermis에 부착시키는 데 중요하다.
