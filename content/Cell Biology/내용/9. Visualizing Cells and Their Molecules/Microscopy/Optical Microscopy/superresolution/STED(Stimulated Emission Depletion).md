...
### 기본 개념
[[|Point spread function]]은 lens에 의해 점 광원이 초점을 맞출 때 형성되는 three-dimensional blurred image 내 빛 강도의 분포다. Diffraction effects 때문에 점 광원과 동일하게 imaging되는 대신, 이미지는 Gaussian distribution에 의해 대략적으로 설명되는 강도 분포를 가지며, 이것이 lens system의 resolution을 결정한다.
## STED의 원리
