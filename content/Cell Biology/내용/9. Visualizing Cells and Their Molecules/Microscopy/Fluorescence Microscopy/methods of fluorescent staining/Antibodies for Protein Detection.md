...
- **일반적 사용 형광 염료**:
  ...
  - [[000_Fluorescence Microscopy(형광현미경)#^0db42b|hodamine(로다민)]]: Green-yellow light(녹황색광)로 여기하면 deep red fluorescence(진한 적색 형광) 방출
...
- Primary antibody에 결합하는 antibody
- Labeled secondary antibodies의 group이 사용될 때 더 강한 signal(신호) 생성
- 이 과정을 indirect immunocytochemistry(간접 면역세포화학)라고 함
