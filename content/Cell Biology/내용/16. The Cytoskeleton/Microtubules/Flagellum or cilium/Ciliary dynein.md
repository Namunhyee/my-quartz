...
Dynein head가 ATP를 가수분해하면 B microtubule의 minus end 방향으로 이동하려 한다. 이는 인접 doublet 사이에 sliding force를 발생시킨다. Axoneme 내에서 모든 dynein이 동시에 활성화되지는 않으며, 이러한 비대칭적 dynein 활성화가 특징적인 wave-like 운동을 만들어낸다.
