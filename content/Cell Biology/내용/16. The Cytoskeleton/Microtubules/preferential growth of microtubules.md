...
**구조**
- Centrosome 내부에 **L자형으로 배치된 한 쌍**이 존재
- 각 centriole: **9세트의 microtubule triplet**이 원통형으로 배열 → 9중 대칭
...
| 주요 기능 | Primary cilia의 basal body | 분열 후 새로운 mother가 됨 |
...
- **Biomolecular condensation**으로 형성되는 dense spherical matrix
...
| 시기 | Centriole 기능 |
|---|---|
| Interphase | 세포막 근처로 이동 → primary cilium 형성 |
| S phase | Primary cilium 흡수 → centriole 복제 |
| Mitosis | 두 centrosome → spindle 양극 형성 |
...
|---|---|---|---|
| 동물 fibroblast | Centrosome | ✓ | Plus end → 세포 주변부, 방사형 aster |
| 출아 효모 | **Spindle pole body** (핵막 내장) | ✗ | — |
| 식물 세포 | 핵막 주변 + 세포 cortex | ✗ | γ-TuRC 사용 |
| 상피 세포 | 극화 후 apical surface 쪽 | ✓ | Plus end → basal 방향 (세로 배열) |
| 신경 세포 axon | 세포체 centrosome | ✓ | **Uniform**: plus end → axon terminal |
| 신경 세포 dendrite | 세포체 centrosome | ✓ | **Mixed polarity** |
...
- [[preferential growth of microtubules]] — dynamic instability
