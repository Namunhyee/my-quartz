...
Secretory pathway는 ER에서 시작하여 Golgi apparatus를 거쳐 세포 표면 또는 다른 목적지로 단백질과 지질을 운반하는 경로이다. 이 pathway는 [[Sorting Signal#ER로의 protein import|ER로 들어온 단백질]]들이 최종 목적지에 도달하는 주요 경로를 구성한다.
...
- ==Signal 도착 시까지 대기==
- ==Ca²⁺를 주요 trigger로 사용==[^기출_중간_2022_36]
...
2. **Neurotransmitter**
   - [[synaptic vesicles|Synaptic vesicle]]의 small molecule
...
==사진에서 염색된 것은 clathrin==
==secretory vesicle이 성숙하면서 clathrin의 이탈, 분비 단백질 응축==

**형성 과정:** 
1. ==**TGN에서 aggregation**==
   - Secretory protein들이 TGN lumen에서 응집. 두 가지 가설이 있음.
      - ==낮은 pH와 높은 Ca²⁺ 환경이 응집 촉진(**aggregation hypothesis**)==
...
3. **Mature secretory vesicle**
   - 매우 응축된 core
   - 조밀하게 packed된 cargo
   - Plasma membrane 근처에서 대기

#### Rapid Signal-triggered Exocytosis

==**Triggering mechanism:**==
![[Cell Biology/출처/md converted/Chapter 13/_page_32_Picture_8.jpeg]]
...
3. ==**Vesicle fusion**==
   ...
   - [[SNARE|SNARE complex]] ==활성화==
   - ==Membrane fusion 개시==
   - 자세한 mechanism은 [[synaptic vesicles]]
4. ==**Cargo 방출**==
   - Vesicle content의 extracellular space 방출
   - Vesicle membrane의 plasma membrane 통합

![[Cell Biology/출처/md converted/Chapter 13/_page_32_Picture_9.jpeg]]
...
- 지속적인 membrane 추가
- [[_endocytosis_MOC|Endocytosis]]를 통한 membrane 회수
- 세포 크기 일정 유지
...
#### ==Sorting Mechanism==
- [[direct sorting in TGN|TGN에서 직접 분류]]
...
[^기출_중간_2022_36]: [[Cell Biology/기출 DB/중간고사/2022년/mid_2022_36번|2022 중간 36번]] — Constitutive와 regulated secretory pathway의 차이, regulated pathway에서 Ca²⁺가 주요 trigger로 작용함이 정답 근거로 활용됨.
