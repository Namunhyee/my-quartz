...
ER에서 단일 종류의 N-linked oligosaccharide가 많은 단백질에 부착되고, 단백질이 여전히 ER에 있는 동안 trimming된다. 이러한 trimming 반응에 의해 생성된 oligosaccharide intermediate는 단백질 folding을 돕고, [[ER-associated degradation|misfolded 단백질을 세포질로 운반하여 proteasome에서 분해]]하는 데 중요한 역할을 한다.
