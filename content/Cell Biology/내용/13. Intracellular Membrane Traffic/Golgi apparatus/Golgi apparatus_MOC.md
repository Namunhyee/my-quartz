...
Golgi apparatus(Golgi complex)는 ER로부터 전달받은 단백질과 지질을 가공하고, 분류하여 세포의 다양한 목적지로 운반하는 주요 분류 및 발송 거점이다. 동물 세포의 Golgi apparatus는 대개 핵 근처, [[Centrosome|centrosome]] 가까이에 위치한다.

![[Cell Biology/출처/md converted/Chapter 13/_page_20_Figure_7.jpeg]]
...
[[functional compartmentalization of the Golgi apparatus|Golgi apparatus의 기능적 구획화]]를 참조하라.
...
한 구획에서 다음 구획으로 cargo를 운반하는 transport vesicle을 사용한다. COPI-coated vesicle이 forward 및 backward transport 모두에 사용될 수 있다.

### 2. Cisternal maturation 메커니즘

새로운 cis cisterna가 ER에서 온 vesicular tubular cluster의 융합으로 지속적으로 형성된다. Cargo가 cisterna 내에서 수정됨에 따라, 효소는 transport vesicle로 떠나 새로 도착하는 vesicular tubular cluster와 융합한다. 동시에, cisterna는 나중 Golgi cisternae에서 온 효소를 포함하는 transport vesicle을 받아들여 medial cisterna로 전환된다.
...
Golgin은 stiff coiled-coil domain과 interspersed hinge region으로 구성된 긴 tether를 형성한다. Golgi stack 표면에서 100-400 nm까지 확장할 수 있는 촉수 숲을 형성한다.

![[Cell Biology/출처/md converted/Chapter 13/_page_27_Figure_13.jpeg]]

서로 다른 golgin family member는 Golgi stack의 서로 다른 영역에서 발견되며, 서로 다른 Rab 단백질에 대한 binding site를 포함한다. 서로 다른 위치에서 온 transport vesicle은 그 위에 특징적인 Rab 단백질을 가지고 있기 때문에, golgin은 어떤 transport vesicle이 Golgi stack의 어떤 부분과 접촉하는지 초기에 선택하는 tether 역할을 한다고 생각된다.
...
- [[../../12. Intracellular Organization and Protein Sorting/Protein translocation into ER|ER로의 단백질 전위]]
- [[../exocytosis/exocytosis_MOC|Exocytosis]]
- [[../Lysosome/Lysosome_MOC|Lysosome]]
- [[../../10. Membrane Structure/Lipid bilayer|Lipid bilayer]]