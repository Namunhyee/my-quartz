...
1. **Core 단백질 준비**: ER에서 합성되어 Golgi apparatus로 전달된 core 단백질

2. **Glycosaminoglycan chain 중합화**: Core 단백질의 serine 잔기에 glycosaminoglycan chain 중합
   - 긴 unbranched 중합체
   - 반복되는 disaccharide unit으로 구성

3. **황산화**: Glycosaminoglycan이 Golgi apparatus에서 즉시 중합된 직후 심하게 황산화됨
...
1. **세포외기질 구조**: Proteoglycan은 조직의 구조적 완전성과 hydration에 기여
2. **세포-세포 상호작용**: 막 proteoglycan은 세포 표면 수용체로 작용 가능
3. **Growth factor 조절**: 일부 proteoglycan은 growth factor를 결합하여 그 활성을 조절

## 관련 주제

- [[Golgi apparatus_MOC|Golgi apparatus]]
- [[functional compartmentalization of the Golgi apparatus|Golgi apparatus의 기능적 구획화]]
- [[../../19. Cell Junctions and the Extracellular Matrix/Extracellular Matrix|세포외기질]]