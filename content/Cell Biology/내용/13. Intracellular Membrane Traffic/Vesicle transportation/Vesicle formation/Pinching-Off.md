...
**Dynamin**은 주요 pinching-off protein이다:[^기출_중간_2022_23][^기출_중간_2023_2]

### 구조와 기능
- **<mark style="background:#fff88f">GTPase domain</mark>**: GTP hydrolysis 조절
- [[Phosphatidylinositol(PI) and Phosphoinositides(PIPs)|PI(4,5)P2]]<mark style="background:#fff88f">-binding domain</mark>**: cytosolic leaflet에 tether. PI(4,5)P<sub>2</sub>
- **Multiple dynamin molecule**: Budding vesicle neck 주위에 spiral로 조립

### Pinching-off Mechanism

**Assembly**:
1. Dynamin molecule들이 막의 PI(4,5)<sub>2</sub>와 결합하면서 결집하여 vesicle neck 주위에 ring 형성 (dynamin을 <mark style="background:#fff88f">membrane translocation</mark>했다고 표현함. 세포질에 떠 있던 단백질이 세포막으로 이동해 결합했다. protein translocation과는 다른 것.)
2. Ring이 spiral structure로 조립
...
### Stepping Model
1. **GTP binding**: Dynamin dimer의 GTPase domain이 adjacent rung의 GTPase domain과 상호작용
2. **GTP hydrolysis**: Conformational change로 dynamin molecule compaction
...
[^기출_중간_2022_23]: [[Cell Biology/기출 DB/중간고사/2022년/mid_2022_23번|2022 중간 23번]] — Dynamin의 GTPase domain, PI(4,5)P₂-binding domain, vesicle neck 주위 spiral 조립 후 GTP hydrolysis에 의한 constriction 메커니즘이 정답 근거로 활용됨.
[^기출_중간_2023_2]: [[Cell Biology/기출 DB/중간고사/2023년/mid_2023_2번|2023 중간 2번]] — Dynamin의 pinching-off 메커니즘에 관한 선지 ⑤가 정답.
