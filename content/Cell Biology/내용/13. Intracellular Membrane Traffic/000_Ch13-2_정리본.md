...
**LDL receptor 재활용**: Occupied 여부 무관, 10분마다 왕복, 20시간 수명 동안 수백 번 순환

### 유전적 결함 (Familial Hypercholesterolemia)

- LDL receptor 결함 → 혈중 cholesterol 축적 → 조기 atherosclerosis

![[Cell Biology/출처/md converted/Chapter 13/_page_39_Picture_7.jpeg]]

Endocytosis 이후 receptor의 처리:
1. Recycling transport vesicles: cargo 처리 후 receptor 재활용
2. Transcytosis: 세포 반대편으로 cargo 전달
3. Degradation in endolysosome: 분해
