...
1. SRP detects the signal ^d3e123
	- SRP는 노출된 [[Sorting Signal#Signal Sequences|ER signal sequence]]와 ribosome 모두에 결합하여 [[SRP#^2f59af|translation을 느리게 한다.]] 
...
- All ribosomes originate from the same pool.
- polypeptide가 ER signal sequence를 가지고 있으면 SRP가 이를 인식하고 ER membrane으로 가져옴.
