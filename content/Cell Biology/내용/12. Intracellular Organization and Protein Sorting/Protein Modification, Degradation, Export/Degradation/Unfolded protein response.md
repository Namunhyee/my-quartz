...
==UPR은 세 가지 독립적이면서 협력하는 경로로 구성된다.==[^기출_중간_2021_22] 각 경로는 ER membrane에 있는 transmembrane sensor protein에서 시작하여, 최종적으로 핵에서 전사인자를 활성화한다.
...
ER stress가 발생하면 ATF6가 Golgi apparatus로 수송된다. 이 수송은 [[Transportation from the ER Through the Golgi Apparatus_MOC|COPII vesicle을 통한 정상적인 ER-to-Golgi trafficking]]을 이용한다.
...
[^기출_중간_2021_22]: [[Cell Biology/기출 DB/중간고사/2021년/mid_2021_22번|2021 중간 22번]] — UPR 작용기전: BiP가 IRE1/PERK/ATF6에서 해리되면 각각 XBP1 mRNA splicing, eIF2α 인산화(번역 억제), Golgi에서 S1P/S2P 절단 → ATF6 활성화. ER stress 지속 시 apoptosis. 복기 불완전. (선지 미복기)
[^기출_중간_2023_26]: [[Cell Biology/기출 DB/중간고사/2023년/mid_2023_26번|2023 중간 26번]] — ER 기능에 대한 설명 중 틀린 것. ERAD(misfolded 단백질을 세포질로 역위하여 proteasome 분해)는 실제 맞는 내용. 복기 불완전(복기 오류 가능성 있음).
