...
==ER membrane에 도착한 <u>fatty acid</u>는 **acyl-CoA ligase**에 의해먼저 CoA와 결합하여 활성화된다(<u>fatty acid CoA</u>) **Acyl transferase**가 두 개의 activated fatty acid를 glycerol phosphate에 순차적으로 부착하여 <u>phosphatidic acid</u>를 생성한다.==
...
- ==[[Golgi apparatus_MOC|Golgi]]와 plasma membrane은 Flippase에 의해 [[Asymmetry of the lipid bilayer]]를 유지한다.==
