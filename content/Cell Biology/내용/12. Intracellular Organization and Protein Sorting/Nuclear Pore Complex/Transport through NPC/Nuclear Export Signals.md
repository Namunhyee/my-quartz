...
NLS와 NES를 모두 가진 단백질은 핵과 세포질 사이를 **왕복(shuttling)**할 수 있다. 수입 속도와 수출 속도의 상대적 비율이 단백질의 정상 상태 위치를 결정한다. 어느 하나의 속도를 조절함으로써 단백질의 위치를 변화시킬 수 있다 (→ [[021_Nuclear Transport Regulation_MOC]] 참조).
