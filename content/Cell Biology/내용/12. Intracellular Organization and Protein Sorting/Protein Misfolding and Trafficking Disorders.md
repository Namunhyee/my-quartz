...
==CFTR 단백질 자체가 chloride channel이며, ΔF508 돌연변이는 단백질이 ER에서 올바르게 접히지 못하게 만든다.== [[Quality control of ER protein folding|ER quality control 시스템]]==이 이를 감지하여 단백질을 분해하므로 channel이 세포막에 도달하지 못한다.==
==도달하면 기능할 수 있지만 도달 자체를 못 함.==
...
Lysosome의 기본 역할(세포 내 소화 기관)에 대해서는 [[Cell Biology/내용/12. Intracellular Organization and Protein Sorting/Membrane-enclosed Organelles/Lysosome|Lysosome]] 참조.
...
| 항목         | 내용                                                                                                                       |
| ---------- | ------------------------------------------------------------------------------------------------------------------------ |
| **병태생리**   | Phospholipid [[flippase]] defect → PS ([[Phospholipid#^c8a78d\|phosphatidylserine]]) translocation 억제 → 응고인자 복합체 형성 장애   |
