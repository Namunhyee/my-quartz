...
1. **TGN에서 aggregation**
   ...
   - <font color="#245bdb">낮은 pH와 높은 Ca²⁺ 환경이 응집 촉진</font>(<mark style="background:#fff88f">aggregation hypothesis. 가설임</mark>)
...
1. **<mark style="background:#fff88f">Maturation process</mark>**
   - [[Clathrin coat|Clathrin-coated vesicle]]<mark style="background:#fff88f">을 통한 membrane retrieval</mark>
...
4. **Mature secretory vesicle**
   - 매우 응축된 core
   - 조밀하게 packed된 cargo
   - <mark style="background:#fff88f">Plasma membrane 근처에서 대기</mark>
...
- 지속적인 membrane 추가
- [[endocytosis_MOC|Endocytosis]]를 통한 membrane 회수
- 세포 크기 일정 유지
