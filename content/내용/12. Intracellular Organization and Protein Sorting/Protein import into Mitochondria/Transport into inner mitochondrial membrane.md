...
3. Signal sequence 다음에 위치한 **소수성 transmembrane domain**이 TIM23 복합체에 의해 인식됨
4. Transmembrane domain이 측면(lateral gate)으로 방출되어 inner membrane에 삽입, 수송 중단
5. 나머지 단백질은 TOM complex를 통해 intermembrane space로 이동
6. Signal sequence는 matrix의 signal peptidase에 의해 절단됨

이 경로는 비교적 큰 N-terminal lumenal/matrix domain이 없는 단순한 inner membrane 단백질에 적용된다.

## 경로 2: TIM22 복합체를 통한 삽입 (대사물질 transporter류)[^기출_중간_2021_19][^기출_기말_2022_5]
...
[^기출_중간_2021_19]: [[Cell Biology/기출 DB/중간고사/2021년/mid_2021_19번|2021 중간 19번]] — 세포질 단백질을 inner mitochondrial membrane과 IMS로 수송하는 방법: TIM23 lateral release(경로 1), TIM22 pathway(경로 2, 대사물질 transporter), MIA pathway(IMS 포획). 복기 불완전. (선지 미복기)
[^기출_기말_2022_5]: [[Cell Biology/기출 DB/기말고사/2022년/final_2022_5번|2022 기말 5번]] — TIM22는 내막 캐리어 단백질(ADP/ATP carrier 등) 삽입에 관여한다는 선지 ④가 정답. IMS chaperone(Tim9·Tim10)이 TIM22로 안내하며 막전위로 올바른 topology 확보. 복기 완성.
